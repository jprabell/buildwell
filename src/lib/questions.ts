    ...
    questions: [
      {
        ...
        required: true,
        options: [
          { value: "slab", label: "Slab on Grade", image: "/images/questionnaire/found-slab.jpg" },
          { value: "crawl_space", label: "Crawl Space", image: "/images/questionnaire/found-crawlspace.jpg" },
          { value: "full_basement", label: "Full Basement", image: "/images/questionnaire/found-basement.jpg" },
          { value: "walkout_basement", label: "Walkout Basement", image: "/images/questionnaire/found-walkout.jpg" },
          { value: "pier_beam", label: "Pier & Beam", image: "/images/questionnaire/found-pier-beam.jpg" },
          { value: "helical_piers", label: "Helical Piers (slopes/unstable soil)", image: "/images/questionnaire/found-helical-piers.jpg" },
          { value: "none", label: "No Foundation (skids/gravel)", image: "/images/questionnaire/found-gravel-skid.jpg" },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        required: true,
        options: [
          { value: "gable", label: "Gable (standard A-shape)", image: "/images/questionnaire/roof-gable.jpg" },
          { value: "hip", label: "Hip Roof", image: "/images/questionnaire/roof-hip.jpg" },
          { value: "gambrel", label: "Gambrel (barn-style)", image: "/images/questionnaire/roof-gambrel.jpg" },
          { value: "shed", label: "Shed / Mono-pitch", image: "/images/questionnaire/roof-shed.jpg" },
          { value: "flat", label: "Flat / Low-slope", image: "/images/questionnaire/roof-flat.jpg" },
          { value: "metal_standing_seam", label: "Standing Seam Metal", image: "/images/questionnaire/roof-standing-seam.jpg" },
          { value: "butterfly", label: "Butterfly", image: "/images/questionnaire/roof-butterfly.jpg" },
          { value: "dome", label: "Dome", image: "/images/questionnaire/roof-dome.jpg" },
        ],
      },
      {
        id: "roofMaterial",
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        type: "select",
        options: [
          { value: "central_hvac", label: "Central HVAC (forced air)", image: "/images/questionnaire/hvac-central.jpg" },
          { value: "mini_split", label: "Mini-Split System", image: "/images/questionnaire/hvac-mini-split.jpg" },
          { value: "radiant_floor", label: "Radiant Floor Heat", image: "/images/questionnaire/hvac-radiant-floor.jpg" },
          { value: "wood_stove", label: "Wood Stove / Pellet Stove", image: "/images/questionnaire/hvac-wood-stove.jpg" },
          { value: "geothermal", label: "Geothermal", image: "/images/questionnaire/hvac-geothermal.jpg" },
          { value: "passive", label: "Passive (no mechanical)", image: "/images/questionnaire/hvac-passive.jpg" },
          { value: "propane_furnace", label: "Propane Furnace", image: "/images/questionnaire/hvac-propane.jpg" },
        ],
      },
    ],
  },
...
const CONTAINER_STEPS: QuestionStep[] = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        type: "select",
        options: [
          { value: "linear", label: "Linear / End-to-End", image: "/images/questionnaire/container-linear.jpg" },
          { value: "parallel", label: "Parallel / Side-by-Side", image: "/images/questionnaire/container-parallel.jpg" },
          { value: "l_shape", label: "L-Shape", image: "/images/questionnaire/container-l-shape.jpg" },
          { value: "u_shape", label: "U-Shape", image: "/images/questionnaire/container-u-shape.jpg" },
          { value: "stacked", label: "Stacked (multi-story)", image: "/images/questionnaire/container-stacked.jpg" },
          { value: "mixed", label: "Mixed / Custom", image: "/images/questionnaire/container-mixed.jpg" },
        ],
      },
    ],
  },
