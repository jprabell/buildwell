...
export async function POST(
  ...
  const projectUrl = `https://ibuildwell.com/projects/${id}/preview/quote_package`;
  ...
  const html = `
    <div style="font-family:sans-serif;max-width:620px;margin:0 auto;padding:32px 24px;background:#fafaf9">
      ...
      <a href="${projectUrl}" style="display:inline-block;background:#d97706;color:white;font-weight:700;padding:12px 28px;border-radius:10px;text-decoration:none;font-size:14px">
        View Full Bid Package →
      </a>
